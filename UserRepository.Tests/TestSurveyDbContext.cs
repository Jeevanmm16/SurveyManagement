...
namespace SurveyManagement.Tests.Repository
{
    ...
    {
        // Marked as static to address CA1822
        private static SurveyManagement.Infrastructure.Repository.UserRepository GetRepository(out SurveyDbContext context)
        {
            ...
            return new SurveyManagement.Infrastructure.Repository.UserRepository(context);
        }
